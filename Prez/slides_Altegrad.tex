...
\frame
{
	\frametitle{Best combination}
	\begin{itemize}
	\item	Trade-off between classification performance and time to train and predict
	\item RF and SVM have the best performance (SVM slightly better)
	\item RF is quicker to train
	\item Weighted graph of words with degree centrality are the best features
	\item Same trade-off for the size of the window
	\end{itemize}
}
